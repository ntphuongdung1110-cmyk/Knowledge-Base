...
## 🔴 Cần xử lý ngay (Overdue hoặc due sớm)
...
| # | Task | Mảng | Priority | Ghi chú |
|---|---|---|---|---|
| 1 | Verify context files (campaign, core, backoffice) với BookStack | QC | Medium | |
| 2 | Thử chạy /sa0.../sa3 với ticket thật | QC | Medium | |
| 3 | Nghiên cứu AI hỗ trợ công việc quản lý và hỗ trợ team | QC | Low | |
| 4 | Build workflow AI QC | AI | Low | Giai đoạn sau |

---

## ✅ Hoàn thành gần đây

| # | Task | Ngày xong | Ghi chú |
|---|---|---|---|
| — | *(chưa có)* | | |
...
Khi Claude xử lý thông tin từ cuộc họp:
- Action items mới → thêm vào section **Đang làm** hoặc **Tuần này**
- Task hoàn thành → di chuyển xuống **Hoàn thành gần đây**
- Task quá hạn → di chuyển lên **Cần xử lý ngay**

Format chuẩn cho 1 task:
```
| N | Mô tả task rõ ràng | [QC/AI/PD] | DD/MM/YYYY | @người | Nguồn meeting/call |
```
...
- [Home](../Home.md)
- [Project Roster](../roster/project-roster.md)
- Source: `~/second-brain/tasks.md`
